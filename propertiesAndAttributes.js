...
class BigBangProps extends HTMLElement {
  constructor() {
    super();
  ...
  // anytime you provide a value as long as it is part of
  // ["character", "color"] the method is going to be called
  // it will tell you which attribute was changed, the old value and the new value
...
customElements.define("big-bang-props", BigBangProps);
